...
/**
 * SystemLogService
 * Captura logs críticos do runtime (stdout/stderr) e os persiste no Redis
 * para visualização no Painel de Controle, eliminando a necessidade de SSH.
 */
export class SystemLogService {
    private static redis: Redis | null = null;
    private static LOG_KEY = 'sys:runtime_logs';
    private static MAX_LOGS = 1000; // Mantém os últimos 1000 logs
    ...
    private static hookConsole() {
        ...
        console.log('[SystemLogService] Console hooks attached. Logs are being streamed to Redis.');
    }
